...
const Home = () => {
	...
	imageArray = [
	'https://media.discordapp.net/attachments/1156773996558307430/1160474658693464155/0-removebg-preview.png?ex=6534cb3f&is=6522563f&hm=b6f699513ef9bf1a9c796dd1e28331149d6ec4cb744a4bf2149cea9f97047dc8&=',
	...
	const updateVisuals = async () => {
		...
		try {
			const response = await fetch("http://localhost:3000/api/getWeekRecords", {
				method: "GET",
				body: js,
				headers: { "Content-Type": "application/json" },
			});
